		...
		<section class="content container-fluid">
			<div class="box box-danger">
	            ...
	            <div class="box-body table-responsive no-padding">
					...
					<div class="pull-left">
			            <ol>
				              <li> Password length must be 8 - 12 characters/ Độ dài Mật khẩu cho phép từ 8-12 ký tự. </li>
				               <li> Password is case sensitive/ Mật khẩu yêu cầu chú ý viết hoa viết thường. </li>
				                <li>Password must contain numbers and special characters/ Mật khẩu phải bao gồm ký tự số và ký tự đặc biệt. </li>
