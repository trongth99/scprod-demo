	...
	<div style="display: block;">
		<div class="pull-left">
		     ...
		     <div class="pull-right " style=" margin-top: 35px;">
			     <a href="${contextPath }/logout-ekyc-doanh-nghiep" class="btn btn-default btn-flat ">Logout/ <i>Đăng Xuất</i></a>
			</div> 
			<div class="pull-right " style=" margin-top: 35px;margin-right: 10px;">
				<a href="${contextPath }/doanh-nghiep/change-pass" class="btn btn-default btn-flat ">Change Password/ <i>Đổi Mật Khẩu</i></a>
			</div>
