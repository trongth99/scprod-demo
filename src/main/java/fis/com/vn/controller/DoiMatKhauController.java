...
public class DoiMatKhauController extends BaseController {
	...
	public String get(Model model, HttpServletRequest req, @RequestParam Map<String, String> allParams,
		...
		try {
			...
			if (userInfo == null)
				throw new Exception("User does not exists/ Người dùng không tồn tại");
			...
			redirectAttributes.addFlashAttribute("success", "Change password successfully/ Đổi mật khẩu thành công");
